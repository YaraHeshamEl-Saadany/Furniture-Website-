...
<link href="ContactSuccessfully.css" rel="stylesheet">
...
<div id="wb_Text2">
<span style="color:#3CB371;font-family:Arial;font-size:13px;">Your form send Successfully!</span></div>
<div id="wb_CssMenu3">
<ul role="menubar">
...
<label for="Label2" id="Label1">Name:</label>
<input type="text" id="Editbox2" name="name" value="" spellcheck="false">
<label for="Button2" id="Label2">Email:</label>
